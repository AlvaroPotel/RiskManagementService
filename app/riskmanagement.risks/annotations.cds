...
annotate service.Risks with @(
    UI.FieldGroup #GeneratedGroup : {
        ...
        Data : [
            ...
            {
                $Type : 'UI.DataField',
                Label : 'suppliear_BusinessPartner',
                Value : suppliear_BusinessPartner,
            },
            {
                $Type : 'UI.DataField',
                Value : miti_ID,
            ...
            {
                $Type : 'UI.DataField',
                Value : suppliear.BusinessPartnerFullName,
                Label : 'BusinessPartnerFullName',
            },
            {
                $Type : 'UI.DataField',
                Value : suppliear.BusinessPartnerCategory,
    ...
    suppliear @(
        Common.ValueList : {
            ...
            Parameters : [
                {
                    $Type : 'Common.ValueListParameterInOut',
                    LocalDataProperty : suppliear_BusinessPartner,
